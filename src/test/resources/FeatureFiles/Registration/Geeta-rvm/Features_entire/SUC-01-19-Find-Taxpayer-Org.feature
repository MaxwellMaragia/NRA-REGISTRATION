Feature: [SUC:01-19] Find Taxpayer-Org
  ...
  Scenario: UAT_TCS 01.17.7 To verify the Process of Finding Taxpayer from other functionality (use Case)
    ...
    When Select Taxpayer Classification Type "Organisation"
    Then advanced org search is displayed
    When enters Tin value as "C0000036358"
    When In Find screen user Clicks Search
    Then user with Tin "C0000036358" is displayed on input "RegisterIndividual:TINInd"
    ...
    When enters Tin value as "C0000036358"
    When In Find screen user Clicks Search
    Then user with Tin "C0000036358" is displayed on input "SuspendRegime:TINInd"
    ...
    When enters Tin value as "C0000036358"
    When In Find screen user Clicks Search
    Then user with Tin "C0000036358" is displayed on input "RegisterRegime:TINInd"
    ...
    When enters Tin value as "C0000036358"
    When In Find screen user Clicks Search
    Then user with Tin "C0000036358" is displayed on input "DeregisterRegime:TINInd"
    ...
    When enters Tin value as "C0000036358"
    When In Find screen user Clicks Search
    Then user with Tin "C0000036358" is displayed on input "ReregisterRegime:TINInd"
    ...
    When enters Tin value as "C0000036358"
    When In Find screen user Clicks Search
    Then user with Tin "C0000036358" is displayed on input "TransferTaxpayer:TINInd"
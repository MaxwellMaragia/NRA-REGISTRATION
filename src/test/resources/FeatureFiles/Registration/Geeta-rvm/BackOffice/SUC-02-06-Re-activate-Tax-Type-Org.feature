Feature: [SUC:02-06] Re-activate Tax Type-Organisation
  ...
  Scenario Outline:  UAT_TCS 01.30.1-To verify the Process of Reactivating a Tax type
    ...
    Examples:
      ...
      | Approved | Organisation        | N0000020354 | 06/04/2029 | Taxable Turnover exceeds threshold | Processing Completed - Reference Number - ARN |

  @UAT_TCS-01.30.2
  Scenario Outline:  UAT_TCS 01.30.2-UAT_TCS 01.30.3-UAT_TCS 01.30.6-To verify the Process of Reactivating a Tax type
    Given User navigates to the login page
    When Enters the username "tripsuser" and password "Passw0rd"
    Then User should be logged in
    And  Click on regisration link
  ...
  @UAT_TCS-01.30.4
  Scenario Outline:  UAT_TCS 01.30.4-To verify the Process of checking Validation Errors
    Given User navigates to the login page
    When Enters the username "tripsuser" and password "Passw0rd"
    Then User should be logged in
    And  Click on regisration link
    ...
    Examples:
      ...
      | Organisation        | N0000020354 |

  @UAT_TCS-01.30.5
  Scenario Outline:  UAT_TCS 01.30.5-To verify the Process of Supervisor rejecting the Application
    Given User navigates to the login page
    When Enters the username "tripsuser" and password "Passw0rd"
    Then User should be logged in
    And  Click on regisration link
    ...
    Examples:
      ...
      | Rejected | Organisation        | N0000020354 | 06/04/2029 | Taxable Turnover exceeds threshold | Processing Completed - Reference Number - ARN | Tax Type to Re-Activate | Error in data capture |
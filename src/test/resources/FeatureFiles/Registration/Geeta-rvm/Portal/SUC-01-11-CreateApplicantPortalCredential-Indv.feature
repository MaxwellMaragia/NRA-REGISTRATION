...
#  @SUC:01-11
  Scenario:UAT_TCS 03.02.2 To Verify the process of Validating Mandatory Details
    ...
    #@SUC:01-11
  Scenario Outline:UAT_TCS 03.02.1-UAT_TCS 03.02.4 To verify the process of successfully creating portal credentials
    ...
    #    change email after each run
      ...
      | Organisation               | NID Card            | bab000@mailinator.com | Passw0rd@123 | C:\Users\barnaby.kamau\Desktop\id_doc.png |

    #@SUC:01-11
  Scenario Outline:UAT_TCS 03.02.5 To verify the process Validating Unique Identification Details
    Given user inputs identification details
      | FirstName     | Max        |
      | LastName      | Mende      |
      | DOB           | 01/01/1990 |
    ...
    Examples:
    #    change email after each run
      | Taxpayer Registration Type | identification type |
      | Organisation               | NID Card            |
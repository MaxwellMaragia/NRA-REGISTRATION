Feature: [SUC:01-11] Create Applicant Portal Credential
  ...
  #@SUC:01-11
  Scenario Outline:UAT_TCS 03.01.1-UAT_TCS 03.01.4 To verify the process of successfully creating portal credentials
    Given user inputs identification details
#    change id after each use
      | FirstName     | Max        |
      | LastName      | Mende      |
      | DOB           | 01/01/1990 |
      | POB           | Lilongwe   |
...
#    change email after each run
      ...
      | Individual                 | NID Card            | bama6@mailinator.com | Passw0rd@123 | C:\Users\barnaby.kamau\Desktop\id_doc.png |

  #@SUC:01-11
  Scenario Outline:UAT_TCS 03.01.5 To verify the process Validating Unique Identification Details
    Given user inputs identification details
